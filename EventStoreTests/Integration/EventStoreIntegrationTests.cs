...
using EventStoreProjectTests.Infrastructure;
using FluentAssertions;
using Infrastructure.Factories;
using Infrastructure.Repositories;
using NUnit.Framework;

namespace EventStoreProjectTests.Integration
{
    [TestFixture]
    public class EventStoreIntegrationTests : IntegrationTestBase
    {
        ...
        public async Task Given_PersonAggregateCreated_When_SavedToEventStore_Then_ShouldBeTheSameWhenFetched()
        {
            ...
            var personAggregate = Person.CreateNewPerson(personId,"Chuck", "Norris");
        ...
        [Test]
        public async Task Given_PersonAggregate_When_Saved_Then_FetchWithOffset()
        {
            var personId = new PersonId();
            ...
            var result = await _eventStore.LoadAsyncFromOffset(2, 1);
